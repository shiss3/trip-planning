...
import {login, logout} from "@/prisma/auth-actions";
        ...
        <nav className="bg-white shadow-md py-4 border-b border-gray-200">
            <div className="container mx-auto flex justify-between items-center px-6 lg:px-8">
                ...
                <div className="flex items-center space-x-4">
                    {session ?
                        <>
                        <Link href='/trips' className='text-slate-900 hover:text-sky-500 font-bold' >
                            我的旅程
                        </Link>
                        <button
                            onClick={logout}
                            className=' flex bg-gray-800 hover:bg-gray-900 text-white font-bold py-2 px-4 rounded cursor-pointer '>
                            退出
                        </button>
                        </>:
                        <button
